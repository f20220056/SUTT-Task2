                    ...
                    return Padding(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          days_count = snapshot.data!.data[index].runDays.length;
                          class_count = snapshot.data!.data[index].classType.length;
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (BuildContext context) {
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Flexible(
                                        child: Text(
                                            '${snapshot.data!.data[index].trainName} : ${snapshot.data!.data[index].trainNumber}', style: TextStyle(
                                              fontSize: 17,
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Container(
                                            child: Text(snapshot
                                                .data!.data[index].departTime,style: TextStyle(
                                                  fontSize: 15
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Container(
                                            child: Text(snapshot
                                                .data!.data[index].arrivalTime,style: TextStyle(
                                                  fontSize: 15
